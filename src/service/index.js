...
const GLOBAL_DB = {
  GET_CUSTOMER: '/api/CustomerGlobalDb/Get',
  CREATE_CUSTOMER: '/api/CustomerGlobalDb/Create',
  UPDATE_CUSTOMER: '/api/CustomerGlobalDb/Update',
  DELETE_CUSTOMER: '/api/CustomerGlobalDb/Delete',
  ...
  GET_LOCATION: '/api/LocationGlobalDb/Get',
  CREATE_LOCATION: '/api/LocationGlobalDb/Create',
  UPDATE_LOCATION: '/api/LocationGlobalDb/Update',
  DELETE_LOCATION: '/api/LocationGlobalDb/Delete',
  GET_MENU: '/api/MenuGlobalDb/Get',
